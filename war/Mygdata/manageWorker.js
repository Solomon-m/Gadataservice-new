...
console.debug("Inside manageWorker Mygdata::");
				...
				for(var m=0, n; n=l[m]; ++m){
					...
					if(m==linkIndex)
						{	
							...
							text_1.innerHTML="<a href='#' onclick='filterCallData(this .innerHTML)'>"+n+"</a>";
							text_1.setAttribute('title',"Call Story");
							console.log(text_1);	
						}
					else
						{
