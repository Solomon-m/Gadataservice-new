...
console.debug("New Checking ::rowArray"+rowArray);
console.debug("New Checking ::dimension"+dimension);
console.debug("New Checking ::index"+index);
console.log("New Checking:::filtering Data.."+dimension+".."+index);
var filteredData={};
