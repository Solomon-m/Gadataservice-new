...
console.debug("Checking:::::from js filtering Data.."+dimension+".."+index);
console.debug("Checking:::::from js dimension"+dimension);
console.debug("Checking:::::from js rowArray"+rowArray);
console.debug("Checking:::::from js index"+indexs);
var filteredData={};
