...
<!-- <script src="http://images.sb.a-cti.com/testing/shashank/gData/gaXHRProcessor.js"></script> -->
  ...
  <script src="/Mygdata/manageWorker.js"></script>
  <script src="/Mygdata/gaVisual.js"></script>
  <script src="/Mygdata/gaXHRProcessor.js"></script>
...
//       _gaq.push(['_trackPageview']);
  ...
  ga('send', 'pageview');
      ...
      <div class="page-header" style="margin:20px 0 0px;padding-bottom:0">
  		<h2><small>SB Analytics Report</small></h2> <!--  <div><a href="/Loginforsolomon.do"> Login</a></div>-->
