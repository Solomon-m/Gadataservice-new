...
<html>
<link rel="stylesheet" type="text/css" href="http://gadataservice-new.appspot.com/css/dataTable.css">
...
<script type='text/javascript'>
      ...
      function sbEventDetail() {
          ...
          console.log(createDataView("seven",data));
