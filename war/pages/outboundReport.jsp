...
<script>
 ...
 { 
	 processGARequest($j('#dataFilter').serialize(),'http://gabackend.gadataservice-new.appspot.com/fetchV2Outbound.do?');
 }
...
<div  id="msg"class="alert" >
    ...
    <tr>
    <td>
    	<form id="dataFilter"  action='http://gabackend.gadataservice-new.appspot.com/fetchV2Outbound.do'>
...
var csvURl="http://gadataservice-new.appspot.com/getCsvData.do?dateFrom="+dateFrom+"&page=csv";
