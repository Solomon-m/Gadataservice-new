...
public class UrlFetchServiceUtil {
	...
	public static String httpRequest(String urlString, String params, String methodName, String contentType, HashMap<String,String> header){
		...
		try{  
			   System.out.println("Inside UrlFetchServiceUtil httpRequest::");
			  System.out.println("Checking urlString::"+urlString);
		      System.out.println("Checking params::"+params);
		      System.out.println("Checking contentType::"+contentType);
			...
			System.out.println("Checking connectin after adding URL::"+connection);
			...
			System.out.println(e.getMessage());
                ...
                System.out.println("Checking responseJson:::"+responseJson.toString());
