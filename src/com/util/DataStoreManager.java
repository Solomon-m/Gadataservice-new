...
public class DataStoreManager {
	...
	public static void set(Object key, Object dimensions, byte[] value){
		System.out.println("Checking by solomon1:::DataStoreManager.set(Object key, Object accountNumber, Object value): key=" + key + ", accountNumber=" + dimensions);		
		System.out.println("DataStoreManager.set(Object key, Object accountNumber, Object value): key=" + key + ", accountNumber=" + dimensions);
		System.out.println("Checking storing RefreshToken and AccessToken::"+value);
		try{											
	...
	public static byte[] get(Object key, Object dimension){
		System.out.println("check::Key in get" + key + ", dimension=" +  dimension);
		...
		try{
			...
			value = get(key);
			//System.out.println("Checking value inside::try::"+value);
	...
	public static byte[] get(Object key){
		...
		try{
			...
			try{
				...
				System.out.println("Checking what is value::"+value);
			}catch (Exception e) {
				// TODO: handle exception
				e.printStackTrace();
			}
			...
			if(value != null){
				...
				//System.out.println("Checking what is objectContent::"+objectContent);
				//String checkobjectContent = new String(objectContent);
				//System.out.println("Checking json objectContent::"+checkobjectContent);
