...
public class ActionServlet {
	...
	final static String CLIENT_ID = "906974599552-8l8lhl10tc7k4pk9uv7aspf0e3btrlr0.apps.googleusercontent.com";
	/** The Constant CLIENT_SECRET. */	
	final static String CLIENT_SECRET ="CCxpujA30DmCnSXL9IyO_TBT";
	/** The Constant REDIRECT_URL. */	
	final static String REDIRECT_URL ="http://gadataservice-new.appspot.com/oauth2callback.do";
	/** The Constant SCOPE. */ 
	final static String SCOPE="https://www.googleapis.com/auth/analytics.readonly";
	final static List<String> SCOPES = Arrays.asList("https://www.googleapis.com/auth/analytics.readonly");
	...
	{ 
        ...
        System.out.println("Checking oauth2callback in ActionServlet");
		String refreshToken	= "";
		String accessToken 	= "";
		...
		ObjectMapper mapper = new ObjectMapper();
          System.out.println("Checking what is code:::"+code);
          System.out.println("Checking what is error:::"+error);
         // String mytoken=request.getParameter("accessToken");
          //System.out.println("accessToken::"+mytoken);
		
		String payload ="code="+code+"&client_id="+CLIENT_ID+"&client_secret="+CLIENT_SECRET+"&redirect_uri="+REDIRECT_URL+"&grant_type="+grant_type;
		System.out.println("Checking payload::::"+payload);
		try{
			...
			(new MyGaDatastoreService()).storeTempData(resourceBundle.getString("email").toString(),resultMap,"refresh_token");
	...
	/**
	 * The Method is created for temporary check for login purpose only
	 * by solomon 
	 */@RequestMapping(value="/Loginforsolomon.do")
		public void googleLoginUrl(HttpServletResponse response){
			try{
				//log.info(printTime+"Started Loging");
				System.out.println("Inside Temp Loginforsolomon::");
				response.sendRedirect(getBuildinLoginUrl());
			}catch(IOException e){
				//log.warning(printTime+"Probelm in response redirection");
				System.out.println("Problem in response rediredirection::Inside Temp Loginforsolomon::");
				
			}
		}
   /**
    * This method is helper-method for googleLoginUrl method
    */
	 private String getBuildinLoginUrl() {
			// TODO Auto-generated method stub
			//scopes.add(AnalyticsScopes.ANALYTICS_READONLY);
	        //scopes.add("https://www.googleapis.com/auth/userinfo.email");
		    System.out.println("Inside getBuildinLoginUrl method::");
	        url = new GoogleAuthorizationCodeRequestUrl(CLIENT_ID,REDIRECT_URL,SCOPES).setAccessType("offline");
		     //log.info(printTime+"buildlogin"); 
			 System.out.println("Successfully created url::");
			 System.out.println("Checking url in getBuildinLoginUrl::::"+url.build());
			return url.build();
		}
	...
	{	System.out.println("Checking getAuthCode:: in ActionServlet");
		String redirectUri="http://gadataservice-new.appspot.com/oauth2callback.do";
	 ...
	 try
		...
		//Adding  filter params to google API request..
		 ...
		 String redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"906974599552-8l8lhl10tc7k4pk9uv7aspf0e3btrlr0.apps.googleusercontent.com"+"&redirect_uri="+redirectUri+"&response_type=code&scope=https://www.googleapis.com/auth/analytics.readonly&access_type=offline&approval_prompt=force&state="+gaFilter;
	...
	{    System.out.println("Checking getEventDetails:: in ActionServlet");
	...
	System.out.println("inside getGASecvice");
    	...
    	try {
    			...
    			System.out.println("setting url");
       			String redirectUri="http://gadataservice-new.appspot.com/oauth2callback.do";
	   		  	redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"906974599552-8l8lhl10tc7k4pk9uv7aspf0e3btrlr0.apps.googleusercontent.com"+"&redirect_uri="+redirectUri+"&response_type=code&scope=https://www.googleapis.com/auth/analytics.readonly&access_type=offline&approval_prompt=force";
	   		  	System.out.println("redirect URI::::"+redirectString);
	   		 	res.sendRedirect(redirectString);
