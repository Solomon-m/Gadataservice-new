...
public class GCSController {
	...
	final static String CLIENT_ID = "93568883096-ueon19ecenrckj11gqbq0lis72pbe7gk.apps.googleusercontent.com";
	final static String CLIENT_SECRET = "t4_yKv-H_Wg5TLRfyniklaaf";
	final static String REDIRECT_URL = "http://www.gadataservice-mydemo.appspot.com/gcsCallback.do";
	final static String SCOPE="https://www.googleapis.com/auth/devstorage.full_control";
	final static String APPLICATION_NAME="gadataservice-mydemo";
	final static String USER_ID="solomon.mark@a-cti.com";	
    	...
    	try {
    		...
    		{System.out.println("checkign json Structure");
		    		...
		    		{System.out.println("refresh Toekn found");
		    			...
		    			String url="https://www.googleapis.com/upload/storage/v1/b/gadataservice-mydemo.appspot.com/o?uploadType=media&name=GAData";
		    		...
		    		{
		   		  redirectString="https://accounts.google.com/o/oauth2/auth?client_id="+"93568883096-ueon19ecenrckj11gqbq0lis72pbe7gk.apps.googleusercontent.com"+"&redirect_uri="+REDIRECT_URL+"&response_type=code&scope="+SCOPE+"&access_type=offline&approval_prompt=force";
